...
# handles the logic and populates the eval_boards.notify_para_table table with parameters required 
# to create payload for `eval_boards`.`nodemailer_table` and  this event 
...
DO
  BEGIN
      ...
      Insert into eval_boards.notify_para_table(
